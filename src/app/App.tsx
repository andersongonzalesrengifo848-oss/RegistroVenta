...
const bootLogs = [
  ["I", "RegistroVenta", "Inicializando módulo de ventas"],
  ...
  ["I", "RegistroVenta", "Interfaz lista para el usuario"],
] as const;
...
function BootScreen() {
  ...
  return (
    <div className="absolute inset-0 z-30 flex flex-col bg-[#122b28] px-6 pt-24 text-[#eef4ed]">
      ...
      <p className="mt-7 font-[Roboto_Slab] text-3xl tracking-[-0.035em]">RegistroVenta</p>
